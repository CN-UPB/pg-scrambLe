...
cors = CORS(app, resources={r"/mano_create": {"origins": "*"}, r"/mano/remove": {"origins": "*"}, r"/scrambled_ns": {"origins": "*"}, r"/mano_uuid" : {"origins": "*"}, r'/osm/getnsr' : {"origins": "*"} })	
