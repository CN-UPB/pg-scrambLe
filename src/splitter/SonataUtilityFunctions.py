                    ...
                    for k in data.keys():
                        if k == "network_forwarding_paths":    #to check if the key matches with "network_forwarding_paths "
                            ...
                            for network_forwarding_paths_data in network_forwarding_paths:
                                ...
                                network_forwarding_paths_instance = NetworkForwardingPaths(fp_id, policy, self.list_connection_points_graph)
                        ...
                        forwarding_graphs_instance = ForwardingGraphs(fg_id, number_of_endpoints, number_of_virtual_links, constituent_vnfs, constituent_virtual_links, self.list_network_forwarding_paths)
