from OsmSchema import NsdNsdCatalog,Nsd,ConnectionPoint,ScalingGroupDescriptor,ScalingPolicy,ScalingCriteria,VnfdMember,ScalingConfigAction,Vnffgd,Rsp,VnfdConnectionPointRefVnffgd,Classifier,MatchAttributes,ConstituentVnfd,DnsServer,DhcpParams,IpProfileParams,IpProfiles,Vld,VnfdConnectionPointRef,VnfDependency
class osm_utility():
    ...
    def get_osm_nsd(self,received_file_sonata):
    ...
    def set_general_informations(self,source):
        #global id
    ...
    def set_ip_profiles(self,source):
        ...
        if ip_profiles is not None:
            for ip_profiles_data in ip_profiles:
                ...
                ip_profile_params_instance = IpProfileParams(ip_version, subnet_address, gateway_address,
                                                                        security_group, self.list_dns_server,
                                                                        self.list_dhcp_params, subnet_prefix_pool)
                ip_profiles_instance = IpProfiles(name, description, ip_profile_params_instance)
    ...
    def set_vld(self,source):
        ...
        for vld_data in vld:
            ...
            for vnfd_connection_point_ref_data in vnfd_connection_point_ref_vld:
                ...
                vnfd_connection_point_ref_instance = VnfdConnectionPointRef(member_vnf_index_ref, order,
                                                                                       vnfd_id_ref,
                                                                                       vnfd_connection_point_ref)
                self.list_vnfd_connection_point_ref.append(vnfd_connection_point_ref_instance)

            vld_instance = Vld(id, name, short_name, vendor, description, version, type, root_bandwidth,
        ...
        if vnffgd is not None:
            for vnffgd_data in vnffgd:
                ...
                for rsp_data in rsp:
                    ...
                    rsp_instance = Rsp(rsp_id, rsp_name, rsp_vnfd_connection_point_ref, rsp_member_vnf_index_ref, rsp_order, rsp_vnfd_id_ref)
                ...
                for classifier_data in classifier:
                    ...
                    for match_attributes_data in match_attributes:
                        ...
                        match_attributes_instance = MatchAttributes(match_attributes_id, match_attributes_ip_proto, match_attributes_source_ip_address,
                    ...
                    classifier_instance = Classifier(classifier_id, classifier_name, classifier_rsp_id_ref, self.list_match_attributes,
                ...
                vnffgd_instance = Vnffgd(vnffgd_id, vnffgd_name, vnffgd_short_name, vnffgd_vendor, vnffgd_description, vnffgd_version, self.list_rsp,
                                                    self.list_classifier)
