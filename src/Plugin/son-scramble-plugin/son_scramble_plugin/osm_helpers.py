...
def generatePackage(packageType, noRemoveFiles=False, destinationDir="/tmp", descriptorName=None, payload=None, _generate_descriptor_pkg_path="./generate_descriptor_pkg.sh"):
    ...
    if packageType == "nsd":
        # "./generate_descriptor_pkg.sh -t nsd  -c -d ./ test"
        subprocess.run([_generate_descriptor_pkg_path, "-t", "nsd", "-c", "-d", destinationDir, descriptorName], cwd=_CWD)
        ...
        subprocess.run(_cmd, cwd=_CWD)


    elif packageType == "vnfd":
        # "./generate_descriptor_pkg.sh -t vnfd -c -d ./ --image a test"
        subprocess.run([_generate_descriptor_pkg_path, "-t", "vnfd", "-c", "--image", "dummy", "-d", destinationDir, descriptorName], cwd=_CWD)
...
if __name__ == "__main__":
    generatePackage(packageType="nsd", descriptorName="test", payload="ssup", destinationDir="/home/ashwin/Documents/MSc/pg-scramble/pg-scramble/src/Plugin/son-scramble-plugin/son_scramble_plugin/dummy")
    generatePackage(packageType="vnfd", descriptorName="test", payload="ssup", destinationDir="/home/ashwin/Documents/MSc/pg-scramble/pg-scramble/src/Plugin/son-scramble-plugin/son_scramble_plugin/dummy")
