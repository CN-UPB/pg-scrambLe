...
\todo[inline]{Should we include other MANO frameworks as well like tacker, XOS, XMANO and ONOS?? }
...
\todo[inline]{Should we include some projects like UNIFY(multiple
	technology domains orchestrator) , SONATA and VITAL??  }