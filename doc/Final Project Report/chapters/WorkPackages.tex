...
\begin{lstlisting}[language=Pytho,caption=OSM descriptor to Pishahang, label=lis:toSOnata]
import pymongo
...
\begin{lstlisting}[language=Python,caption=Pishahang descriptor to OSM, label=lis:toOSM]
import pymongo
from validate import validator
from utilities import setup
...
Original \textbf{SLM\_mapping} function:
\begin{lstlisting}[language=Python,caption=\textbf{SLM\_mapping} function, label=lis:SLM\_mapping]
...
\begin{lstlisting}[language=Python,caption=Extended \textbf{SLM\_mapping\_scramble} function, label=lis:SLM\_scramble]
